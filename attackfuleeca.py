...
class attack(): 
    ...
    def NumberInTLS(self,x, halfn,p =65521, beta =0.021240595234768,Z = 94.1628598983449,tau=0.25):
        ...
        if a >= 1:
            b=int(round(a-0.1,0)) #This will force the rounding of 0.5 to be 0 instaead of 1
        else:
            if a >= tau:
                b=1
            else:
    ...
    ##attack
    def __init__(self): 
        self.SmallInstancesHalfn = [42,83,165,331,659,991,1319]#the ones that are interesting
